...
to setup-patches
  ...
  [
    ...
    let O2spout1 sugar-levels - ( distancexy 0 12 ) * .35 ;sugar levels proportional to O2 levels
    let O2spout2 sugar-levels - ( distancexy 0 37 ) * .35 ; changed to zero for some crossover
    ...
    ;;; roughing it up
    if (random 2 = 1) [set pO2 0 set psugar 0]
  ]
  color-sugar-patches
end
...
PENS
"done" 1.0 1 -16777216 true "" "histogram [length sequence-history] of turtles"
...
162
DNA Diversity
length remove-duplicates ([sequence-tag] of turtles)
0
1
12
...
length remove-duplicates ([sequence-tag] of turtles) *\nmean [length sequence-history] of turtles
1
1
12
...
1347
84
Wanted to calculate frequency entropy, but kept getting errors in netlogo
8
0.0
1
...
1297
575
From inspection, this measure does seem to indicate the probability of \"interesting behaivor\" or overall system health.
8
0.0
1
...
265
sugar utilization
1 - sum [psugar] of patches / sum [max-psugar] of patches
3
1
11
...
320
O2 Utilization
1 - (sum [pO2] of patches / sum [max-pO2] of patches)
3
1
11
...
<experiments>
  ...
  <experiment name="AlifeExpV.0" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>count pills</metric>
    <metric>count pacmen</metric>
    <metric>count supers</metric>
    <metric>[length sequence-history] of turtles</metric>
    <metric>[sequence-tag] of turtles</metric>
  ...
  <experiment name="AlifeExpV.2" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>count pills with [color = red]</metric>
    <metric>count pills with [color = pink]</metric>
    <metric>count pills</metric>
    <metric>count pacmen with [color = blue]</metric>
    <metric>count supers</metric>
    <metric>count pacmen</metric>
    <metric>[length sequence-history] of turtles</metric>
    <metric>[sequence-tag] of turtles</metric>
  ...
  <experiment name="AlifeExpV.3" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>count pills with [color = red]</metric>
  ...
  <experiment name="AlifeExpV.4" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="250"/>
    <metric>count pills with [color = red]</metric>
    ...
    <metric>[length sequence-history] of turtles</metric>
    <metric>[sequence-tag] of turtles</metric>
    <metric>1 - (sum [pO2] of patches / sum [max-pO2] of patches)</metric>
    <metric>1 - sum [psugar] of patches / sum [max-psugar] of patches</metric>
    <enumeratedValueSet variable="O2-starv-danger-threshold">
      <value value="30"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="sugar-levels">
  ...
  <experiment name="AlifeExpV.5" repetitions="200" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="250"/>
    <metric>count pills with [color = red]</metric>
